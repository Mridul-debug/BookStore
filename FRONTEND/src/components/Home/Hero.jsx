  ...
  return (
    <div className='h-[75vh] flex flex-col md:flex-row items-center justify-center'>
      ...
      <p className='mt-4 text-xl text-zinc-300 text-center lg:text-left'>
        Uncover captivating stories,enriching knowledge, and endless ispiration in our curated collection of books
      </p>
      <div className='mt-8'>
      ...
      <img src='https://static.vecteezy.com/system/resources/previews/036/594/667/non_2x/ai-generated-book-store-advertisment-background-with-copy-space-free-photo.jpg' alt='hero'  />
      </div>
    </div>
  )
}
